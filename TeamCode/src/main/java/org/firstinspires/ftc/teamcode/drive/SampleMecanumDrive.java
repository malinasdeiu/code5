...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public void JoyStickDrive(Gamepad gamepad, double speed){

        double FORWARD_DRIVE = gamepad.left_stick_y;
        double STRAFE_DRIVE = gamepad.left_stick_x;
        double TURN_DRIVE = gamepad.right_stick_x;
        ...
        RR = Range.clip(LR, -speed, speed);
        RF = Range.clip(LR, -speed, speed);
